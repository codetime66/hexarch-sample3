...
@Entity
@Table(name = "TB_CATEG", schema = "USR_ICOR")
public class CategoriaEntity implements Serializable {

	private static final long serialVersionUID = 3522374680520541197L;

	@Id
	@Column(name = "ID_CATEG", nullable = false)
	private long idCategoria;

	@Column(name = "DS_CATEG")
	...
	public String toString() {
		return "CategoriaEntity [idCategoria=" + idCategoria + ", descricao=" + descricao + ", status=" + status
				+ ", dtInclusao=" + dtInclusao + ", dtAlteracao=" + dtAlteracao + ", idUsuarioAlteracao="
				+ idUsuarioAlteracao + ", idUsuarioInclusao=" + idUsuarioInclusao + "]";
	}
